...
<Button text="Allocate" onclick={() => open()} class="plausible-event-name=Button+Allocate"/>
{#if isOpen}
  <div class="modal" on:keydown={keydown} tabindex={0}>
    <div class="content-wrapper">
      <div class="button">
        <Button text="X" textOnly onclick={() => close()} disabled={loading}  class="plausible-event-name=Button+X+Allocate" />
      </div>
      <div>
        {#if data && isOpen}
          <div class="container">
